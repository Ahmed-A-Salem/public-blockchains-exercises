...
async function main() {
    ...
    console.log("Asking question... waiting for confirmation.");
    ...
    console.log("📝 Submitting answer... waiting for confirmation.");
    await answerTx.wait();
    ...
    console.log(`🧠 Your Answer: ${storedAnswer}`);
    console.log(`🎯 Correct? ${answerIsCorrect ? "✅ Yes!" : "❌ No"}`);
}
